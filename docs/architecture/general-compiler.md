...
| **Parse** | Per-language modules → `UnifiedModule` | Full parsers: [`.in`](../in-cli/src/in_lang_parse.rs), [**icore** JSON](../in-cli/src/compiler/icore.rs). Dedicated fronts: [`rust_front`](../in-cli/src/compiler/rust_front.rs), [`go_front`](../in-cli/src/compiler/go_front.rs), [`v_front`](../in-cli/src/compiler/v_front.rs) (real declarations + bounded body-subset lowering; not full language semantics yet). Other extensions: [`compiler::tree_front`](../in-cli/src/compiler/tree_front/mod.rs) (Tree-sitter signature extraction). Unsupported ids still route to `.icore`. |
...
- [architecture/future-work-roadmap.md](architecture/future-work-roadmap.md) — phased backlog (parsers, driver, SIL, hot reload)  
