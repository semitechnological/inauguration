...
pub fn parse_crystal_file(path: &Path) -> Result<UnifiedModule, String> {
    boundary_common::parse_file_with(path, parse_crystal_source)
}

pub fn parse_crystal_artifact(path: &Path) -> Result<CompileArtifact, String> {
    boundary_common::parse_artifact_with(path, parse_crystal_source, extract_crystal_boundary)
}

pub fn parse_crystal_artifact_source(src: &str) -> Result<CompileArtifact, String> {
    boundary_common::artifact_from_source(src, parse_crystal_source, extract_crystal_boundary)
}
