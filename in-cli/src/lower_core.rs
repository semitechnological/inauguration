...
mod tests {
    ...
    #[test]
    fn lower_orders_helpers_and_main() -> Result<(), String> {
        ...
        let pa = sil.find("sil @alpha").ok_or_else(|| "alpha".to_string())?;
        let pz = sil.find("sil @zeta").ok_or_else(|| "zeta".to_string())?;
        let pm = sil.find("sil @main").ok_or_else(|| "main".to_string())?;
        assert!(pa < pz);
        assert!(pz < pm);
        Ok(())
    }
    ...
    #[test]
    fn desugar_closure_captures_one_var() -> Result<(), String> {
        let module = UnifiedModule {
            identity: Default::default(),
            decls: vec![Decl::Function {
                name: "main".into(),
        ...
        let cap_struct = module
            ...
            .ok_or_else(|| "captures struct should exist".to_string())?;
        assert!(
    ...
    #[test]
    fn desugar_closure_captures_two_vars() -> Result<(), String> {
        let module = UnifiedModule {
            identity: Default::default(),
            decls: vec![Decl::Function {
                name: "main".into(),
    ...
    #[test]
    fn desugar_closure_rewrites_captured_var_to_self_field() -> Result<(), String> {
        let module = UnifiedModule {
            identity: Default::default(),
            decls: vec![Decl::Function {
                name: "main".into(),
    ...
    #[test]
    fn desugar_closure_no_captures_empty_struct() -> Result<(), String> {
        let module = UnifiedModule {
            identity: Default::default(),
            decls: vec![Decl::Function {
                name: "main".into(),
        ...
        let cap_struct = module
            ...
            .ok_or_else(|| "captures struct should exist even when empty".to_string())?;
