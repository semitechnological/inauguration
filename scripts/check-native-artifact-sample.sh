...
windows_exe = (out / "answer.exe").read_bytes()
require(windows_exe[:2] == b"MZ", "windows exe missing MZ magic")
require(b"KERNEL32.dll" in windows_exe, "windows exe missing kernel32 import")
require(b"ExitProcess" in windows_exe, "windows exe missing ExitProcess import")
