...
- [ ] Make `.in` the agent-native hybrid language surface.
  ...
  - Next self-hosting slice: add a symbol table for more than one referenced binding and start emitting structured diagnostics for unsupported bootstrap source.
